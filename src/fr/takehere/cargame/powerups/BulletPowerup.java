...
public class BulletPowerup extends Object {

    public BulletPowerup(@Nullable Dimension size, Point location, Image image) {
    ...
    public void collectPowerup(){
        BulletPowerup powerup = this;

        CarGame.getInstance().runNextFrame(new Runnable() {
            @Override
            public void run() {
                Player.get().destroyBulletOnImpact = false;
